...
void appendToJson(const vector<tuple<string,string,string>>& resultPair, const std::string& fileName, bool &printComma);
void printResultToStdout(const vector<tuple<string,string,string>>& resultPair, const std::string& fileName);
